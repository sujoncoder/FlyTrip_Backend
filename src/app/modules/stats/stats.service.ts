...
// USER STATS SERVICE
export const getUserStatService = async () => {
...
// TOUR STATS SERVICE
export const getTourStatService = async () => {
...
export const getBookingStatService = async () => {
...
export const getPaymentStatService = async () => {
